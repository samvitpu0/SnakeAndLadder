...
namespace PsypherLibrary.SupportLibrary.Utils.InternetReachabilityVerifier
{
    public class InternetReachabilityVerifier : GenericManager<InternetReachabilityVerifier>
    {
    ...
    }*/ //-- not used as this class now being derived using generic manager

...
namespace PsypherLibrary.SupportLibrary.Utils.InternetReachabilityVerifier.Editor
{
    [CustomEditor(typeof(InternetReachabilityVerifier))]
    public class InternetReachabilityVerifierInspector : UnityEditor.Editor
    {
